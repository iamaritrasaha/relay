...
pub use relay_core::discovery::DeviceLogKind;
...
use relay_core::model::discovery::{DeviceType, ProtocolType};
use relay_core::multicast::{DEFAULT_MULTICAST_GROUP_V6, MulticastDevice};
...
pub async fn start_discovery(
    ...
    let handle = relay_core::discovery::start(
        DiscoveryConfig {
            group,
