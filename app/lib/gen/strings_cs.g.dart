...
class _Translations$networkInterfacesPage$cs extends Translations$networkInterfacesPage$en {
  ...
  @override
  String get info =>
      'Ve výchozím nastavení používá Relay všechna dostupná síťová rozhraní. Zde můžete vyloučit nežádoucí sítě. Chcete-li použít změny, musíte restartovat server.';
  @override
...
class _Translations$webSharePage$cs extends Translations$webSharePage$en {
  ...
  @override
  String get encryptionHint => 'Relay používá self-signed certifikát. Musíte ho přijmout ve vašem prohlížeči.';
  @override
...
class _Translations$aboutPage$cs extends Translations$aboutPage$en {
  ...
  // Translations
  @override
  String get title => 'O aplikaci Relay';
  @override
...
class _Translations$donationPage$cs extends Translations$donationPage$en {
  ...
  @override
  String get info => 'Relay je zdarma, open source a bez reklam. Pokud se vám aplikace líbí, můžete její vývoj podpořit darem.';
  @override
...
class _Translations$tray$cs extends Translations$tray$en {
  ...
  @override
  String get close => 'Ukončit Relay';
  @override
...
class _Translations$settingsTab$general$cs extends Translations$settingsTab$general$en {
  ...
  @override
  String get showInContextMenu => 'Zobrazit Relay v kontextové nabídce';
  @override
...
class _Translations$settingsTab$other$cs extends Translations$settingsTab$other$en {
  ...
  @override
  String get support => 'Podpora Relay';
  @override
...
class _Translations$dialogs$localNetworkUnauthorized$cs extends Translations$dialogs$localNetworkUnauthorized$en {
  ...
  @override
  String get description => 'Relay nemůže najít jiná zařízení, aniž by měl oprávnění skenovat místní síť. Udělte prosím toto oprávnění v nastavení.';
  @override
...
class _Translations$dialogs$sendModeHelp$cs extends Translations$dialogs$sendModeHelp$en {
  ...
  @override
  String get link => 'Příjemci, kteří nemají nainstalovaný Relay, si mohou vybrané soubory stáhnout otevřením odkazu ve svém prohlížeči.';
}
