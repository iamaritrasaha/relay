...
class _Translations$networkInterfacesPage$bg extends Translations$networkInterfacesPage$en {
  ...
  @override
  String get info =>
      'По подразбиране, Relay използва всички налични мрежови интерфейси. Тук можете да изключите нежелани мрежи. Трябва да рестартирате сървъра, за да приложите промените.';
  @override
...
class _Translations$receiveOptionsPage$bg extends Translations$receiveOptionsPage$en {
  ...
  @override
  String get appDirectory => '(папка на Relay)';
  @override
...
class _Translations$webSharePage$bg extends Translations$webSharePage$en {
  ...
  @override
  String get encryptionHint => 'Relay използва самоподписан сертификат. Трябва да го приемете във вашия браузър.';
  @override
...
class _Translations$aboutPage$bg extends Translations$aboutPage$en {
  ...
  // Translations
  @override
  String get title => 'Относно Relay';
  @override
  List<String> get description => [
    'Relay е безплатно приложение с отворен код, което ви позволява сигурно да споделяте файлове и съобщения с устройства наблизо през вашата локална мрежа, без да се нуждаете от интернет връзка.',
...
class _Translations$donationPage$bg extends Translations$donationPage$en {
  ...
  @override
  String get info =>
      'Relay е безплатен, с отворен код и без никакви реклами. Ако харесвате приложението, можете да подкрепите разработката с дарение.';
  @override
...
class _Translations$tray$bg extends Translations$tray$en {
  ...
  @override
  String get close => 'Излезте от Relay';
  @override
...
class _Translations$settingsTab$general$bg extends Translations$settingsTab$general$en {
  ...
  @override
  String get showInContextMenu => 'Покажи Relay в контекстното меню';
  @override
...
class _Translations$settingsTab$other$bg extends Translations$settingsTab$other$en {
  ...
  @override
  String get support => 'Поддръжка на Relay';
  @override
...
class _Translations$dialogs$localNetworkUnauthorized$bg extends Translations$dialogs$localNetworkUnauthorized$en {
  ...
  String get description =>
      'Relay не може да намери други устройства без разрешение за сканиране на локалната мрежа. Моля, предоставете това разрешение в настройките.';
  @override
...
class _Translations$dialogs$sendModeHelp$bg extends Translations$dialogs$sendModeHelp$en {
  ...
  @override
  String get link => 'Получателите, които нямат инсталиран Relay, могат да изтеглят избраните файлове, като отворят връзката в своя браузър.';
}
