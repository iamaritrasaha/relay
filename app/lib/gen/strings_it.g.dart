...
class _Translations$networkInterfacesPage$it extends Translations$networkInterfacesPage$en {
  ...
  @override
  String get info =>
      'Per impostazione predefinita, Relay utilizza tutte le interfacce di rete disponibili. È possibile escludere le reti indesiderate. È necessario riavviare il server per applicare le modifiche.';
  @override
...
class _Translations$receiveOptionsPage$it extends Translations$receiveOptionsPage$en {
  ...
  @override
  String get appDirectory => '(cartella Relay)';
  @override
...
class _Translations$webSharePage$it extends Translations$webSharePage$en {
  ...
  @override
  String get encryptionHint => 'Relay utilizza un certificato autofirmato. Devi accettarlo nel browser.';
  @override
...
class _Translations$aboutPage$it extends Translations$aboutPage$en {
  ...
  // Translations
  @override
  String get title => 'Informazioni su Relay';
  @override
  List<String> get description => [
    'Relay è un\'app gratuita e open-source che consente di condividere file e messaggi in modo sicuro con dispositivi vicini sulla tua rete locale, senza bisogno di una connessione internet.',
...
class _Translations$donationPage$it extends Translations$donationPage$en {
  ...
  @override
  String get info =>
      'Relay è gratuito, open-source e privo di pubblicità. Se ti piace l\'applicazione, puoi supportarne lo sviluppo con una donazione.';
  @override
...
class _Translations$tray$it extends Translations$tray$en {
  ...
  @override
  String get close => 'Esci da Relay';
  @override
...
class _Translations$settingsTab$general$it extends Translations$settingsTab$general$en {
  ...
  @override
  String get showInContextMenu => 'Mostra Relay nel menù contestuale';
  @override
...
class _Translations$settingsTab$other$it extends Translations$settingsTab$other$en {
  ...
  @override
  String get support => 'Supporta Relay';
  @override
...
class _Translations$dialogs$localNetworkUnauthorized$it extends Translations$dialogs$localNetworkUnauthorized$en {
  ...
  String get description =>
      'Relay non può trovare altri dispositivi senza il permesso per la scansione della rete locale. Puoi concedere questo permesso nelle impostazioni.';
  @override
...
class _Translations$dialogs$sendModeHelp$it extends Translations$dialogs$sendModeHelp$en {
  ...
  @override
  String get link => 'I destinatari che non hanno installato Relay possono scaricare i file selezionati aprendo il link nel loro browser.';
}
