...
class _Translations$networkInterfacesPage$uk extends Translations$networkInterfacesPage$en {
  ...
  @override
  String get info =>
      'Типово Relay використовує всі доступні мережеві інтерфейси. Ви можете виключити небажані мережі тут. Щоб застосувати зміни, потрібно перезапустити сервер.';
  @override
...
class _Translations$webSharePage$uk extends Translations$webSharePage$en {
  ...
  @override
  String get encryptionHint => 'Relay використовує самопідписаний сертифікат. Вам потрібно прийняти його в браузері.';
  @override
...
class _Translations$donationPage$uk extends Translations$donationPage$en {
  ...
  @override
  String get info =>
      'Relay — це безплатна програма з відкритим вихідним кодом та без реклами. Якщо вона вам подобається, ви можете підтримати її розробку пожертвою.';
  @override
...
class _Translations$tray$uk extends Translations$tray$en {
  ...
  @override
  String get close => 'Вийти з Relay';
  @override
...
class _Translations$settingsTab$general$uk extends Translations$settingsTab$general$en {
  ...
  @override
  String get showInContextMenu => 'Відображати Relay в контекстному меню';
  @override
...
class _Translations$settingsTab$other$uk extends Translations$settingsTab$other$en {
  ...
  @override
  String get support => 'Підтримати Relay';
  @override
...
class _Translations$dialogs$localNetworkUnauthorized$uk extends Translations$dialogs$localNetworkUnauthorized$en {
  ...
  String get description =>
      'Relay не може знайти інші пристрої без дозволу на сканування локальної мережі. Будь ласка, надайте цей дозвіл у налаштуваннях.';
  @override
...
class _Translations$dialogs$sendModeHelp$uk extends Translations$dialogs$sendModeHelp$en {
  ...
  @override
  String get link => 'Отримувачі, у яких не встановлено Relay, можуть завантажити вибрані файли, відкривши посилання у своєму браузері.';
}
