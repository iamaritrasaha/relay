...
class Translations$networkInterfacesPage$en {
  ...
  /// en: 'By default, Relay uses all available network interfaces. You can exclude unwanted networks here. You need to restart the server to apply the changes.'
  String get info =>
      'By default, Relay uses all available network interfaces. You can exclude unwanted networks here. You need to restart the server to apply the changes.';
...
class Translations$webSharePage$en {
  ...
  /// en: 'Relay uses a self-signed certificate. You need to accept it in your browser.'
  String get encryptionHint => 'Relay uses a self-signed certificate. You need to accept it in your browser.';
...
class Translations$aboutPage$en {
  ...
  /// en: 'About Relay'
  String get title => 'About Relay';

  List<String> get description => [
    'Relay is a free, open-source app that allows you to securely share files and messages with nearby devices over your local network without needing an internet connection.',
...
class Translations$donationPage$en {
  ...
  /// en: 'Relay is free, open-source and without any ads. If you like the app, you can support the development with a donation.'
  String get info => 'Relay is free, open-source and without any ads. If you like the app, you can support the development with a donation.';
...
class Translations$settingsTab$general$en {
  ...
  /// en: 'Show Relay in context menu'
  String get showInContextMenu => 'Show Relay in context menu';
...
class Translations$settingsTab$other$en {
  ...
  /// en: 'Support Relay'
  String get support => 'Support Relay';
...
class Translations$dialogs$localNetworkUnauthorized$en {
  ...
  /// en: 'Relay can't find other devices without having the permission to scan the local network. Please grant this permission in the settings.'
  String get description =>
      'Relay can\'t find other devices without having the permission to scan the local network. Please grant this permission in the settings.';
...
class Translations$dialogs$sendModeHelp$en {
  ...
  /// en: 'Recipients who do not have Relay installed can download the selected files by opening the link in their browser.'
  String get link => 'Recipients who do not have Relay installed can download the selected files by opening the link in their browser.';
}
