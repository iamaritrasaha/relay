...
class _Translations$networkInterfacesPage$be extends Translations$networkInterfacesPage$en {
  ...
  @override
  String get info =>
      'Прадвызначана, Relay выкарыстоўвае ўсе даступныя сеткавыя інтэрфейсы. Тут вы можаце выключыць непажаданыя сеткі. Каб змяненні ўступілі ў сілу, трэба перазапусціць сервер.';
  @override
...
class _Translations$webSharePage$be extends Translations$webSharePage$en {
  ...
  @override
  String get encryptionHint => 'Relay выкарыстоўвае самападпісаны сертыфікат. Вам трэба прыняць яго ў браўзеры.';
  @override
...
class _Translations$donationPage$be extends Translations$donationPage$en {
  ...
  @override
  String get info =>
      'Relay — бясплатная праграма з адкрытым зыходным кодам і без рэкламы. Калі вам падабаецца праграма, вы можаце падтрымаць яе распрацоўку ахвяраваннем.';
  @override
...
class _Translations$tray$be extends Translations$tray$en {
  ...
  @override
  String get close => 'Выйсці з Relay';
  @override
...
class _Translations$settingsTab$general$be extends Translations$settingsTab$general$en {
  ...
  @override
  String get showInContextMenu => 'Паказваць Relay у кантэкстным меню';
  @override
...
class _Translations$settingsTab$other$be extends Translations$settingsTab$other$en {
  ...
  @override
  String get support => 'Падтрымаць Relay';
  @override
...
class _Translations$dialogs$localNetworkUnauthorized$be extends Translations$dialogs$localNetworkUnauthorized$en {
  ...
  @override
  String get description => 'Relay не можа знайсці іншыя прылады, не маючы дазволу на сканіраванне лакальнай сеткі. Дайце гэты дазвол у наладах.';
  @override
...
class _Translations$dialogs$sendModeHelp$be extends Translations$dialogs$sendModeHelp$en {
  ...
  @override
  String get link => 'Атрымальнікі, у якіх не ўсталяваны Relay, могуць спампаваць выбраныя файлы, адкрыўшы спасылку ў браўзеры.';
}
