...
class _Translations$networkInterfacesPage$nl extends Translations$networkInterfacesPage$en {
  ...
  @override
  String get info =>
      'Standaard gebruikt Relay alle beschikbare netwerkinterfaces. Je kunt hier ongewenste netwerken uitsluiten. Je moet de server opnieuw opstarten om de wijzigingen toe te passen.';
  @override
...
class _Translations$receiveOptionsPage$nl extends Translations$receiveOptionsPage$en {
  ...
  @override
  String get appDirectory => '(Relay-map)';
  @override
...
class _Translations$webSharePage$nl extends Translations$webSharePage$en {
  ...
  @override
  String get encryptionHint => 'Relay maakt gebruik van een zelfondertekend certificaat. Je moet dit accepteren in je browser.';
  @override
...
class _Translations$aboutPage$nl extends Translations$aboutPage$en {
  ...
  // Translations
  @override
  String get title => 'Over Relay';
  @override
  List<String> get description => [
    'Relay is een gratis en opensource app waarmee je veilig bestanden en berichten met apparaten op je lokale netwerk kunt delen, zonder internetverbinding.',
...
class _Translations$donationPage$nl extends Translations$donationPage$en {
  ...
  @override
  String get info =>
      'Relay is gratis, opensource en advertentievrij. Als je de app graag gebruikt, kun je de ontwikkeling steunen middels een donatie.';
  @override
...
class _Translations$tray$nl extends Translations$tray$en {
  ...
  @override
  String get close => 'Relay afsluiten';
  @override
...
class _Translations$settingsTab$general$nl extends Translations$settingsTab$general$en {
  ...
  @override
  String get showInContextMenu => 'Relay weergeven in contextmenu';
  @override
...
class _Translations$settingsTab$other$nl extends Translations$settingsTab$other$en {
  ...
  @override
  String get support => 'Relay steunen';
  @override
...
class _Translations$dialogs$localNetworkUnauthorized$nl extends Translations$dialogs$localNetworkUnauthorized$en {
  ...
  String get description =>
      'Relay heeft rechten nodig om op het lokale netwerk naar andere apparaten te kunnen zoeken. Verleen deze rechten in de instellingen.';
  @override
...
class _Translations$dialogs$sendModeHelp$nl extends Translations$dialogs$sendModeHelp$en {
  ...
  @override
  String get link => 'Ontvangers die Relay niet hebben geïnstalleerd kunnen de bestanden downloaden door de link in hun browser te openen.';
}
