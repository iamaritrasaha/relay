...
class _Translations$networkInterfacesPage$hi extends Translations$networkInterfacesPage$en {
  ...
  @override
  String get info =>
      'डिफ़ॉल्ट रूप से, Relay सभी उपलब्ध नेटवर्क इंटरफेस का उपयोग करता है। आप यहां अवांछित नेटवर्क को बाहर कर सकते हैं। परिवर्तनों को लागू करने के लिए आपको सर्वर को पुनः आरंभ करना होगा।';
  @override
...
class _Translations$receiveOptionsPage$hi extends Translations$receiveOptionsPage$en {
  ...
  @override
  String get appDirectory => '(Relay फ़ोल्डर)';
  @override
...
class _Translations$aboutPage$hi extends Translations$aboutPage$en {
  ...
  // Translations
  @override
  String get title => 'Relay के बारे में';
  @override
  List<String> get description => [
    'Relay एक मुफ्त, ओपन-सोर्स ऐप है जो आपको अपने स्थानीय नेटवर्क पर पास के डिवाइसों के साथ इंटरनेट कनेक्शन की आवश्यकता के बिना सुरक्षित रूप से फाइलें और संदेश साझा करने की अनुमति देता है।',
...
class _Translations$donationPage$hi extends Translations$donationPage$en {
  ...
  @override
  String get info => 'Relay मुफ्त, ओपन-सोर्स और बिना किसी विज्ञापन के है। यदि आपको ऐप पसंद है, तो आप विकास का समर्थन दान करके कर सकते हैं।';
  @override
...
class _Translations$tray$hi extends Translations$tray$en {
  ...
  @override
  String get close => 'Relay बंद करें';
  @override
...
class _Translations$settingsTab$general$hi extends Translations$settingsTab$general$en {
  ...
  @override
  String get showInContextMenu => 'कॉन्टेक्स्ट मेनू में Relay दिखाएं';
  @override
...
class _Translations$settingsTab$other$hi extends Translations$settingsTab$other$en {
  ...
  @override
  String get support => 'Relay का समर्थन करें';
  @override
...
class _Translations$dialogs$localNetworkUnauthorized$hi extends Translations$dialogs$localNetworkUnauthorized$en {
  ...
  String get description =>
      'Relay स्थानीय नेटवर्क को स्कैन करने की अनुमति के बिना अन्य डिवाइसों को नहीं ढूंढ सकता। कृपया सेटिंग्स में यह अनुमति दें।';
  @override
...
class _Translations$dialogs$sendModeHelp$hi extends Translations$dialogs$sendModeHelp$en {
  ...
  @override
  String get link => 'जिन प्राप्तकर्ताओं के पास Relay इंस्टॉल नहीं है, वे अपने ब्राउज़र में लिंक खोलकर चयनित फ़ाइलें डाउनलोड कर सकते हैं।';
}
