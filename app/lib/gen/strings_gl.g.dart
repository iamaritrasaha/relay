...
class _Translations$networkInterfacesPage$gl extends Translations$networkInterfacesPage$en {
  ...
  @override
  String get info =>
      'Por defecto, Relay emprega todas as interfaces de rede dispoñíbeis. Eiquí podes desactivar as redes non desexadas. Tes que reiniciar o servidor para aplicar os cambios.';
  @override
...
class _Translations$receiveOptionsPage$gl extends Translations$receiveOptionsPage$en {
  ...
  @override
  String get appDirectory => '(Cartafol Relay)';
  @override
...
class _Translations$webSharePage$gl extends Translations$webSharePage$en {
  ...
  @override
  String get encryptionHint => 'Relay precisa un certificado autoasinado. Tes que aceptalo no teu navegador.';
  @override
...
class _Translations$aboutPage$gl extends Translations$aboutPage$en {
  ...
  // Translations
  @override
  String get title => 'Acerca de Relay';
  @override
  List<String> get description => [
    'Relay é unha aplicación gratuita, de código aberto, que che permite compartir ficheiros e mensaxes de xeito seguro con dispositivos cercanos a través da túa rede local sen necesidade dunha conexión a internet.',
...
class _Translations$tray$gl extends Translations$tray$en {
  ...
  @override
  String get close => 'Saír de Relay';
  @override
...
class _Translations$settingsTab$general$gl extends Translations$settingsTab$general$en {
  ...
  @override
  String get showInContextMenu => 'Amosar Relay no menú contextual';
  @override
...
class _Translations$settingsTab$other$gl extends Translations$settingsTab$other$en {
  ...
  @override
  String get support => 'Apoia a Relay';
  @override
...
class _Translations$dialogs$localNetworkUnauthorized$gl extends Translations$dialogs$localNetworkUnauthorized$en {
  ...
  String get description =>
      'Relay non pode atopar outros dispositivos sen ter permiso para escanear a rede local. Por favor, concede este permiso na configuración.';
  @override
...
class _Translations$dialogs$sendModeHelp$gl extends Translations$dialogs$sendModeHelp$en {
  ...
  @override
  String get link => 'Os destinatarios que non teñan instalado Relay poden descargar os ficheiros seleccionados abrindo a ligazón no seu navegador.';
}
