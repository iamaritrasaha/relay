...
enum PurchaseItem {
  donate5(
    androidId: 'relay_android_donate_5',
    iosId: 'relay_ios_donate_5',
  ),
  donate10(
    androidId: 'relay_android_donate_10',
    iosId: 'relay_ios_donate_10',
  ),
  donate20(
    androidId: 'relay_android_donate_20',
    iosId: 'relay_ios_donate_20',
  ),
  donate50(
    androidId: 'relay_android_donate_50',
    iosId: 'relay_ios_donate_50',
  )
  ;
